window.onload = function(){
	...
	var newest = document.getElementsByClassName('newest')[0];
	var hisNews = document.getElementsByClassName('his_news')[0];
	

	sideList[0].onclick = function(){
		newest.style.display = 'block';
		hisNews.style.display = 'none';

	}
	sideList[1].onclick = function(){
		newest.style.display = 'none';
		hisNews.style.display = 'block';
	}
	...
	var newsSim = document.getElementsByClassName('news_sim');
	var newsDet = document.getElementsByClassName('news_det');
